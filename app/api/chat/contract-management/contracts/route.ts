...
import { createContractAgent } from '@/workflows/contract-management/agent/contract-agent';
...
const callOptions = modelId ? { selectedModel: modelId } : undefined;
  ...
  // IMPORTANT: Pass originalMessages to maintain tool invocation context after approval
  const agentStream = await createAgentUIStream({
    agent,
    messages: validatedMessages,
    originalMessages: allMessages, // Original messages before validation - needed for tool approval matching
